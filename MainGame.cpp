...
2. 일시정지를 누르면 일시정지가 되고 재생버튼으로 바뀐다.
3. 이전 버튼을 누르면 이전곡
4. 다음 버튼을 누르면 다음곡
5. 재상바가 있어야 하고 중간을 클릭하면 중간부터 재생
6. 곡 재생 시간이 표시되어야 하고 전체 시간 표기
7. 한 곡의 재생이 끝나면 다음곡으로 넘어간다. >자동
8. 이미지는 윈앰프 이미지로
9. 곡에 대한 이름까지
노래 7곡 해당되는 앨범 이미지 /이영지 그냥 /스마일리 /블라스퍼머스노래 /스위치 /
볼륨조절 필수
